        ...
        return new UserQueryImpl(((ProcessEngineConfigurationImpl) ProcessEngines.getDefaultProcessEngine().
            ...
            public List<User> executeList(CommandContext commandContext, Page page) {
                ...
                if(StringUtils.isNoneBlank(id)) {
                    ...
                    Class userClass = com.hframework.base.bean.AuthContext.AuthUser.userClass;
                    ...
                    try {
                        ...
                        ReflectUtils.setFieldValue(po, ResourceWrapper.JavaUtil.getJavaVarName(dataSet.getKeyField().getCode()), Long.valueOf(id));
...
//                        Object userInfo = ReflectUtils.invokeMethod(service, "get" + userClass.getSimpleName() + "ByPK", new Class[]{Long.class}, new Object[]{Long.valueOf(id)});
                        ...
                        userEntity.setLastName(BeanUtils.getProperty(userInfo, ResourceWrapper.JavaUtil.getJavaVarName(dataSet.getNameField().getCode())));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
