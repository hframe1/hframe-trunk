...
public class WebContextHelper {
    ...
    private void format() {
        programConfigRootDir = PropertyConfigurerUtils.getProperty(ProgramResourceConst.PROGRAM_CONFIG_ROOT_DIR,
                "hframework".equals(companyCode) ? "hframe" : companyCode ,
                "hframe".equals(programCode) ? "trunk" : programCode,
