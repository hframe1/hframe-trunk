...
import com.ucfgroup.client.beetle.bean.getassetchangeresponse.*;

/**
 * generated by hframework on 2016-04-22.
 */
public class GetAssetChangeResponse   {
    ...
    public GetAssetChangeResponse() {
    }
 	
	public GetAssetChangeResponse convert()  throws Exception{
			if(!converted) {
