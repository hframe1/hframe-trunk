...
import com.ucfgroup.client.beetle.bean.getregdetailresponse.*;

/**
 * generated by hframework on 2016-04-22.
 */
public class GetRegDetailResponse   {
    ...
    public GetRegDetailResponse() {
    }
 	
	public GetRegDetailResponse convert()  throws Exception{
			if(!converted) {
