...
import com.ucfgroup.client.beetle.bean.getrepayplanresponse.*;

/**
 * generated by hframework on 2016-04-22.
 */
public class GetRepayPlanResponse   {
    ...
    public GetRepayPlanResponse() {
    }
 	
	public GetRepayPlanResponse convert()  throws Exception{
			if(!converted) {
