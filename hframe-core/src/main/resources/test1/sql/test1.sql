...
) ENGINE=InnoDB AUTO_INCREMENT=151031866277 DEFAULT CHARSET=utf8 COMMENT='实体';
...
) ENGINE=InnoDB AUTO_INCREMENT=151031891596 DEFAULT CHARSET=utf8 COMMENT='实体属性';
...
) ENGINE=InnoDB AUTO_INCREMENT=151031896790 DEFAULT CHARSET=utf8 COMMENT='数据列';
...
) ENGINE=InnoDB AUTO_INCREMENT=151031888475 DEFAULT CHARSET=utf8 COMMENT='数据集';
...
) ENGINE=InnoDB AUTO_INCREMENT=151031110973 DEFAULT CHARSET=utf8 COMMENT='模块';
...
) ENGINE=InnoDB AUTO_INCREMENT=151031375438 DEFAULT CHARSET=utf8 COMMENT='项目';
...
CREATE TABLE `hfpm_program_cfg` (
  ...
  `func_auth_path` varchar(128) DEFAULT NULL COMMENT '功能授权路径',
