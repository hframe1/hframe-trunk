...
//					ResourceWrapper.JavaUtil.getJavaVarName(Column.getColumnName()));
...
//						"List<" + ResourceWrapper.JavaUtil.getJavaClassName(ColumnRelationVo.getTableNameTo()) + ">",
//						ResourceWrapper.JavaUtil.getJavaVarName(ColumnRelationVo.getTableNameTo()) + "List"
//				));
//			}else{
//				poClass.addField(new Field(
//						ResourceWrapper.JavaUtil.getJavaClassName(ColumnRelationVo.getTableNameTo())));
//				containtFk=true;
//			}
//		}
//
...
//						"this." + ResourceWrapper.JavaUtil.getJavaVarName(columnList.get(i).getColumnName()) +
//								" = " + ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+".get"
//								+ResourceWrapper.JavaUtil.getJavaClassName(columnList.get(i).getColumnName())+"();");
//			}
//			for (ColumnRelationVo ColumnRelationVo : relationList) {
//				if(2!=ColumnRelationVo.getType()){
//					constructor.addCodeLn(
//							"this." + ResourceWrapper.JavaUtil.getJavaVarName(ColumnRelationVo.getTableNameTo()) +
//									" = " + ResourceWrapper.JavaUtil.getJavaVarName(ColumnRelationVo.getTableNameTo())+";");
//				}
//			}
//		}
//
...
//		String s="";
//		for (int i = 0; i < columnList.size(); i++) {
//			s+=Constant.column2ObjectType.get(columnList.get(i).getColumnType())+" "+ResourceWrapper.JavaUtil.getJavaVarName(columnList.get(i).getColumnName());
//
