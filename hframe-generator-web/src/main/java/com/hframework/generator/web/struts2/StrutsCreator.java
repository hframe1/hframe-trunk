package com.hframework.generator.web.struts2;
...
//		inputParam.put("VarName", ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName()).toLowerCase());
...
//		//获取参数
//		Map<String, String> inputParam=new HashMap<String, String>();
//		inputParam.put("ClassName", ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName()));
//		inputParam.put("VarName", ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName()).toLowerCase());
//		inputParam.put("UserName",username);
//		inputParam.put("DbName",dbName);
//
//		//获取findAll方法
