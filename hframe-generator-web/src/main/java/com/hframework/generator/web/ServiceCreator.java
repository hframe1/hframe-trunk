...
////			sb.append("public class "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+"Serv {/n/n");
//		//注入对应的DAO
...
////
////		//引入该表对应的dao，vo对象
////		String poPath=serviceFileName.substring(serviceFileName.indexOf("/src/")+5,serviceFileName.lastIndexOf("/service/")).replace("/", ".")+".po."+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName());
...
////
////		sb.append("@Component/n");
////		sb.append("public class "+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName())+"Serv {/n/n");
////
////		//注入对应的DAO
////		for (Table table : coreTableList) {
////			sb.append(CreatorUtil.injectBean(table.getTableName(),"DAO"));
...
////
////			String serviceName=ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName());
////			//获得table对应serv文件的名称
...
////					sql.append(ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+"."+ResourceWrapper.JavaUtil.getJavaVarName(coreTableColumn.getColumnName())+",");
////				}
////			}
////		}
...
////		for (Table table : tableList) {
////			List<Column> tableColumnList = table.getColumnList();
////			sql.append(ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+",");
////		}
////		sql.substring(0,sql.length()-1);
////
...
////		inputParam.put("ClassName", ResourceWrapper.JavaUtil.getJavaClassName(tableList.get(0).getTableName()));
////		inputParam.put("VarName", ResourceWrapper.JavaUtil.getJavaVarName(tableList.get(0).getTableName()));
////		inputParam.put("VOClassName", ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName()));
////		inputParam.put("VOVarName", ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName()));
////		inputParam.put("sqlAheadPart", sqlAheadPart);
////		inputParam.put("PkColumnName", ResourceWrapper.JavaUtil.getJavaVarName(tableList.get(0).getColumnList().get(0).getColumnName()));
////
////		//获取findAll方法
...
////		for (CoreTableColumnRelationVo coreTableColumnRelationVo : relationList) {
////
////			inputParam.put("ClassName", ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName()));
////			inputParam.put("VarName", ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName()));
////			inputParam.put("FkClassName", ResourceWrapper.JavaUtil.getJavaClassName(coreTableColumnRelationVo.getColumnName()));
////			inputParam.put("FkVarName", ResourceWrapper.JavaUtil.getJavaVarName(coreTableColumnRelationVo.getColumnName()));
////
...
////
////		sb.append("  public void create("+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"){/n/n");
////		sb.append("    try{/n");
////
////		List<Table> tableList=coreSet.getCoreTableList();
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+" = new "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+"();/n");
////		}
////		for (Table table : tableList) {
////			List<Column> columnList=table.getColumnList();
////			for (Column coreTableColumn : columnList) {
////				if(coreSetContainsStr(coreSet,coreTableColumn)){
////					sb.append("      "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+".set"+ResourceWrapper.JavaUtil.getJavaClassName(coreTableColumn.getColumnName())+"("+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+".get"+ResourceWrapper.JavaUtil.getJavaClassName(coreTableColumn.getColumnName())+"());"+"/n");
////				}
////			}
////		}
////
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+Type+" .saveOrUpdate("+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+");/n");
////		}
////
////
...
////
////
////		sb.append("  public void batchCreate("+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName())+"[] "+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"s){/n/n");
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+"[] "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+"s = new "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+"["+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"s.length];/n");
////		}
////		sb.append("      for(int i=0;i<"+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"s.length;i++){/n");
////
//////		for (Table table : tableList) {
//////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+" = new "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+"();/n");
//////		}
...
////			for (Column coreTableColumn : columnList) {
////				if(coreSetContainsStr(coreSet,coreTableColumn)){
////					sb.append("          "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+"s[i].set"+ResourceWrapper.JavaUtil.getJavaClassName(coreTableColumn.getColumnName())+"("+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"s[i].get"+ResourceWrapper.JavaUtil.getJavaClassName(coreTableColumn.getColumnName())+"());"+"/n");
////				}
////			}
////		}
////		sb.append("      }/n");
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+Type+" .batchSave("+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+"s);/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
...
////
////
////		//sb.append("  public void batchCreate(List<"+ResourceWrapper.JavaUtil.getJavaClassName(tableName)+"> "+ResourceWrapper.JavaUtil.getJavaVarName(tableName)+"s){/n/n");
////		sb.append("  public void batchCreate(List "+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"s){/n/n");
////		sb.append("     batchCreate(("+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName())+"[])"+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"s.toArray(new "+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName())+"[0])"+");/n/n");
////		sb.append("  }/n/n");
////
////
////
////		sb.append("  public void update("+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"){/n/n");
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+" = new "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+"();/n");
////		}
...
////
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+Type+" .update("+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+");/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
////		sb.append("  }/n/n");
////
////		sb.append("  public void delete("+ResourceWrapper.JavaUtil.getJavaClassName(coreSet.getCoreSetName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(coreSet.getCoreSetName())+"){/n/n");
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+" "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+" = new "+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName())+"();/n");
////		}
...
////
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+Type+" .delete("+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+");/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
...
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+ResourceWrapper.JavaUtil.getJavaVarName(table.getTableName())+Type+" .delete(id);/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
