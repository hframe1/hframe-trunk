package com.hframework.generator.web.hibernate;
...
//
//			String xmlName=ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName());
//
...
//		String poPath=xmlFileName.substring(xmlFileName.indexOf("/src/")+5,xmlFileName.lastIndexOf("/hbm/")).replace("/", ".")+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName()).toLowerCase()+".po."+ResourceWrapper.JavaUtil.getJavaClassName(table.getTableName());
...
//				idElement.setAttribute("name", ResourceWrapper.JavaUtil.getJavaVarName(column.getColumnName()));
...
//				propertyElement.setAttribute("name", ResourceWrapper.JavaUtil.getJavaVarName(column.getColumnName()));
